...
#define kLPScrollingTickerHSpace                4.0f
// Default animation speed
#define kLPScrollingAnimationPixelsPerSecond    100.0f
...
- (void) beginAnimation {
    ...
    //[scrollView scrollRectToVisible:CGRectMake(scrollView.contentSize.width, 0, 1, 1) animated:YES];
    ...
    [UIView animateWithDuration:animationDuration delay:0.0 usingSpringWithDamping:0.9 initialSpringVelocity:0.2 options:UIViewAnimationOptionAllowUserInteraction | UIViewAnimationOptionAutoreverse | UIViewAnimationOptionRepeat animations:^{
...
- (NSString *) description {
    return [NSString stringWithFormat:@"text='%@,%@' frame=%@",titleLabel.text,descriptionLabel.text,NSStringFromCGRect(titleLabel.frame)];
}
